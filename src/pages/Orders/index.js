...
const Orders = () => {
    ...
    /* AddToCart */
    const listCarts = localStorage.getItem('cart') ? JSON.parse(localStorage.getItem('cart')) : [];
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                                <div className="section-cart">
                                                    ...
                                                    <div className="mb-2">
                                                        <label htmlFor="phone" className="form-label">Number Phone</label>
                                                        <input type="phone" className="form-control" id="phone" readOnly placeholder="0909 160 056" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
